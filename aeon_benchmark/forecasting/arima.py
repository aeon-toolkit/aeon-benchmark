...
stationary_arma_models = {
    ...
    (5, 2): ([0.5, -0.3, 0.2, -0.1, 0.05], [0.4, -0.2]),

    (3, 4): ([0.4, -0.25, 0.1], [-0.3, 0.2, -0.1, 0.05]),
    (4, 3): ([0.55, -0.35, 0.2, -0.1], [-0.25, 0.15, -0.1]),
    (5, 4): ([0.5, -0.3, 0.2, -0.1, 0.05], [-0.3, 0.2, -0.1, 0.05]),
    (5, 5): ([0.5, -0.3, 0.2, -0.1, 0.05], [-0.25, 0.2, -0.15, 0.1, -0.05]),
